					...
					?>
						<table class="full-width configuration-form-table">
							...
							<tr>
								...
								<td>
									<textarea class="configuration-input-default textarea-default" name="description" placeholder="Veuillez ne pas mettre de message pouvant offenser les autres joueurs ou ne pas respecter les CGU"<?php echo $verrouillage; ?>><?php echo $tournoi->getDescription(); ?></textarea>
								</td>							
							</tr>
							<?php
								if(trim($verrouillage)!=="disabled"){
