...
<html lang="fr">
	<head>
		...
		<meta name="robots" content="index,follow" />
			...
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/template.css" media="screen">';?>

			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/general-stylesheet.css">';?>

			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/animation.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/background.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/body.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/border.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/button.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/caption.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/checkbox.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/cursor.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/display.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/failed-input.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/float.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/font.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/grid.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/header.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/hr.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/icon.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/image.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/input-radio.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/input.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/loading.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/margin.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/menu.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/navbar.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/overflow.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/padding.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/position.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/search.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/shadow.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/select.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/size.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/text.css">';?>
			<?php echo '<link rel="stylesheet" type="text/css"  href="' . WEBPATH . '/web/css/module/transform.css">';?>
